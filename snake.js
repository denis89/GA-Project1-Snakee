...
// console.log(paintFood(Math.round(Math.random()*300),Math.round(Math.random()*300,"blue")));
...
function nextFood(){
  paintFood(Math.round(Math.random()*300),Math.round(Math.random()*300));
